...
import type { BehavioralDistributionPoint } from '../../utils/behavioralSignals';

interface RiskDistributionProps {
  distribution: BehavioralDistributionPoint[];
}

const RiskDistribution = ({ distribution }: RiskDistributionProps) => {
  return (
    <motion.div
    ...
    >
      ...
      <div className="relative z-10 mb-8">
        <h3 className="text-xs font-black text-slate-900 uppercase tracking-[0.2em] mb-1">Early Stress Distribution</h3>
        <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Behavioral segment composition</p>
      </div>
